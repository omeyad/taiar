...
<header class="header" role="banner">
    <div class="wrap">
        ...
        <div class="logo" style="float: left">
            ...
            <img src="{{asset('images/logo3.png')}}" alt="Transfers" />
        </div>
        ...
        <nav role="navigation" class="main-nav">
            <ul>
             ...
             @guest
                            <li><a href="{{ route('login') }}" style="font-size: 20px;color:white;">دخول</a></li>
  <li><a href="blog.html" title="Blog" style="font-size: 20px;"> تسجيل  </a>
                    <ul>
                        <li><a href="/supplierRegister" title="Post" style="font-size: 20px;color:white;">مؤسسه</a></li>
                        <li><a href="/delivaryRegister" title="Post" style="font-size: 20px;color:white;">طيار</a></li>
                ...
                <li><a href="contact.html" title="Contact" style="font-size: 20px;color: white;">اتصل بنا </a></li>


                <li><a href="http://themeforest.net/item/transfers-transport-and-car-hire-html-template/9366018?ref=themeenergy" title="Purchase" style="font-size: 20px;color:white"> من نحن </a></li>
                <li><a href="index-2.html" title="" style="font-size: 20px;color: white;"> الصفحه الرئيسيه </a></li>
