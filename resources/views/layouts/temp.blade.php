  ...
  <li><a href="blog.html" title="Blog" style="font-size: 20px;"> تسجيل  </a>
                    <ul>
                        ...
                        <li><a href="/delivaryRegister" title="Post" style="font-size: 20px;">طيار</a></li>
                            ...
                            <li class="dropdown">
                                <a href="/delivaryProfile" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">
                ...
                <li><a href="/" title="طيلر" style="font-size: 20px;"> الرئيسية </a></li>
